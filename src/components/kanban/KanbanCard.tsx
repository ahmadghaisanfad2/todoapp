...
export function KanbanCard({ task, onEdit, onDelete, crossTasks }: KanbanCardProps) {
  ...
  return (
    <div
      ...
      data-kanban-card
      className={cn(
        'group flex items-start gap-2 rounded-lg border bg-card px-3 py-2.5 shadow-sm cursor-grab active:cursor-grabbing hover:border-primary/30 transition-all duration-150 select-none animate-card-in active:scale-[0.97]',
