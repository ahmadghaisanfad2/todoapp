      ...
      <div className="relative z-10 mx-auto flex h-[100dvh] max-w-6xl items-center px-6 pt-14 pb-8">
        <div className="grid w-full items-center gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="animate-hero-fade-4 flex flex-wrap items-center gap-3">
              <Button
                onClick={onNavigateApp}
                size="lg"
                className="h-11 rounded-xl bg-primary px-6 text-sm font-semibold font-mono shadow-lg shadow-primary/20 transition-all duration-200 hover:shadow-xl hover:shadow-primary/25 hover:scale-[1.02] active:scale-[0.99]"
              >
                Mulai Sekarang
